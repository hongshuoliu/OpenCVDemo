...
public class CameraVerActivity extends CameraBaseActivity implements CvCameraViewListener2, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_ver);
