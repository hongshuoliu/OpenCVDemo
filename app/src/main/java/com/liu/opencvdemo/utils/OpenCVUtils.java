...
public class OpenCVUtils {
    ...
    public static void analysisImage(String imagePath, ImageView imageView, int section) {
        // read image
        ...
        if (section == 0) {
            ...
            backProjectionHistogram(src, dst, imagePath);
        } else if (section == 13) {
            matchTemplateDemo(src, dst, imagePath);
        }
     ...
     * @param iamgePath
     */
    public static void backProjectionHistogram(Mat src, Mat dst, String iamgePath) {
        Mat hsv = new Mat();
        String sampleFilePath = iamgePath.replaceAll("target", "sample");
     ...
     * @param iamgePath
     */
    public static void matchTemplateDemo(Mat src, Mat dst, String iamgePath) {
        String tplFilePath = iamgePath.replaceAll("lena", "tmpl");
