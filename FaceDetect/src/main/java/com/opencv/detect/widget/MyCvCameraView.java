package com.opencv.detect.widget;
...
public class MyCvCameraView extends JavaCameraView implements Camera.PictureCallback {
    ...
    public MyCvCameraView(Context context) {
        super(context, CameraBridgeViewBase.CAMERA_ID_FRONT);
    }
    ...
    public boolean isFrontCamare() {
        return mCameraIndex == CAMERA_ID_FRONT;
    }

    public void setFontCamare() {
        setCameraIndex(CAMERA_ID_FRONT);
        disableView();
        enableView();
    }

    public void setBackCamare() {
